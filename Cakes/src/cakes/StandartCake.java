...
import cakes.abstractAndEnums.StandartCakesEnum;
...
public class StandartCake extends Cake {
	...
	public static  Cake generateStandartBisquidCake() {
		return new StandartCake(22.50f, "StSm", "This is the small one.", (byte) 6, StandartCakesEnum.BISQUID);

	}

	public static Cake generateStandartChocolateCake() {
		return new StandartCake(25.20f, "Chocolate", "The chocolate one", (byte) 8, StandartCakesEnum.CHOCOLATE);
	}

	public static Cake generateStandartFruitCake() {
		return new StandartCake(25.20f, "Fruit", "The fruit one", (byte) 8, StandartCakesEnum.FRUIT);
	}

	public static Cake generateStandartEclerCake() {
		return new StandartCake(22.30f, "StPDDm", "This is the small one.", (byte) 6, StandartCakesEnum.ECLER);
	}
